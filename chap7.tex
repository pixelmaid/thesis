...
todo{put in rationale for why dress code is textual rather than visual programing language}
...
\begin{comment}
\begin{quotation}
\textit{``Instead of doing something that I thought would look cool, I tried to think of something I would generally wear, I didnÕt pick bright pink, because I knew I would never wear that."}
\\Youth Participant K
\end{quotation}
...
\todo{add in flower quote from expert workshop}

Participants also described their designs as being "geometric", "mathematical" or "precise":
\begin{quotation}
...
The affordances of computational design are broad
Design of tools should support these varieties
contextualization of use of tool should encourage specific forms of exploration similar to art or design curriculas 

 feminine and masculine aesthetics
\begin{quotation}
 \textit{``I think it is beautiful for females. Not me. Because, I don't go that way. Because on a female's wrist it looks rightÉ not on mine."}
 \\Youth Participant G
\end{quotation}
...
\\Youth Participant R: \textit{``NoÉ if it is, it's because of the program, not because something unique I brought to it.. ok I think they're all kind of beautiful- ok I just completely changed my answer. It reminds me of stained glass and I think stained glass is really beautiful."}
...
\begin{quotation}
\textit{``usually when you make something you're making it like Òoh I hope society likes thisÓ but this[making the bracelet] was about self satisfaction, so I don't have to take into consideration someone else's opinion."}
\\Youth Participant S
\end{quotation}
