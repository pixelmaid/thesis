...
\caption{"Haute couture" computationally designed and digitally fabricated fashion}
...
\caption{"Ready to wear" computationally designed and digitally fabricated fashion}
\label{fig:accessible_fashion}
\end{figure}
\end{center}
